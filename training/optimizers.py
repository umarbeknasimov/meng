...
def get_optimizer(model: nn.Module, args: TrainingHParams, init_optimizer_state = None):
...
def get_lr_scheduler(args: TrainingHParams, iterations_per_epoch: int, optimizer: Optimizer, init_scheduler_state = None):
