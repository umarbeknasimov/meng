...
class Model(nn.Module):
    ...
    def is_valid_model_name(model_name):
        return "layernorm" in model_name and cifar_resnet.Model.is_valid_model_name(model_name.replace('layernorm_', ''))
    ...
    def get_model_from_name(model_name,  outputs=10):
        ...
        model_name = model_name.replace('layernorm_', '')
    ...
    def default_hparams():
        model_hparams = hparams.ModelHparams(
            model_name='cifar_resnet_layernorm_20'
        )
