...
from models import cifar_resnet, cifar_resnet_layernorm, cifar_resnet_layernorm2, cifar_vgg

registered_models = [cifar_resnet.Model, cifar_vgg.Model, cifar_resnet_layernorm.Model, cifar_resnet_layernorm2.Model]
